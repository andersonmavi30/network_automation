...
PRECHECK_DIR = BASE_DIR / "artifacts" / "precheck"
...
def run_precheck(device_name, device_data):
    device_dir = PRECHECK_DIR / device_name
    ...
    print(f"[OK] Precheck completed for {device_name}")
...
def main():
    ...
    for device_name in target_devices:
        ...
        run_precheck(device_name, device_data)

    print("[OK] Lab 3 precheck completed successfully.")
